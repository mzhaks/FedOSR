...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--save_path', default='./pretrained_models', type=str, help='model weights path')
    parser.add_argument('--dataset', default='Cifar10', type=str, help='Dataset configuration')
    parser.add_argument('--known_class', default=10, type=int, help='Number of known classes')
    parser.add_argument('--unknown_class', default=1, type=int, help='Number of unknown classes')
    ...
    parser.add_argument('--epoches', default=14, type=int, help='Number of epochs')
    ...
    parser.add_argument('--dirichlet', type=float, default=1.0, help='Dirichlet alpha')
